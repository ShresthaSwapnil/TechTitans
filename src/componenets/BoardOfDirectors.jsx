        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {directors.map((director, index) => (
            ...
            >
              ...
              />
              <div className="absolute bottom-0 left-0 right-0 bg-black/30 p-4 group-hover:bg-black/90 transition-all duration-300">
                <h3 className="text-xl font-zentry text-white flex-center">
                  {director.name}
                </h3>
                <p className="text-green-200 flex-center">{director.role}</p>
              </div>
            </div>
          ))}
        </div>
